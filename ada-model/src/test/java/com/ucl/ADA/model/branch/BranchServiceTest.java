...
public class BranchServiceTest {
    ...
    public void testAddBranch(){
        ...
        assertThat(branch1).isEqualTo(branch);
    }

    @Test
    public void testGetBranchByGitRepoAndName(){
        Branch branch = new Branch();
        branch.setBranchName("test1");
        ...
        when(branchRepository.findByRepositoryAndBranchName(repo, "test1")).thenReturn(branch);

        Branch retrievedBranch = branchService.getBranchGivenRepoAndName(repo, "test1");
        verify(branchRepository).findByRepositoryAndBranchName(repo, "test1");
        assertThat(retrievedBranch).isEqualTo(branch);
    }
