...
public class AnalysisRequestController {
    ...
    /**
     * Endpoint for getting an analysis request entity given a Git repository, its owner, name of the branch and
     * timestamp
     *
    ...
    public Snapshot getSnapshotOfAnalysisRequestByOwnerRepoBranchAndTimestamp(@PathVariable String owner,
                                                                    @PathVariable String repository,
                                                                    @PathVariable String branch,
                                                                    @PathVariable String timestamp) {
        return analysisRequestService.getSnapshotOfAnalysisRequestByOwnerRepoBranchAndTimestamp(owner, repository, branch, timestamp);
    }
}
