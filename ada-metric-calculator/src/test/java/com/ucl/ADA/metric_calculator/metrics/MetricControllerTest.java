...
public class MetricControllerTest {
    ...
    void testGetUserById() {
        Metric m = new Metric(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_ATTRIBUTE_INVOCATIONS, 8.07F);
        m.setId(1L);
        ...
        assertThat(metric.getType()).isEqualTo(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_ATTRIBUTE_INVOCATIONS);
    ...
    void testRetrieveAllMetrics() {
        Metric m1 = new Metric(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_ATTRIBUTE_INVOCATIONS, 1.0123F);
        Metric m2 = new Metric(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_CONSTRUCTOR_INVOCATIONS, 2.4567F);
        Metric m3 = new Metric(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_METHOD_INVOCATIONS, 3.8910F);
        ...
        assertThat(retrievedMetrics.get(0).getType()).isEqualTo(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_ATTRIBUTE_INVOCATIONS);
        assertThat(retrievedMetrics.get(0).getValue()).isEqualTo(1.0123F);

        assertThat(retrievedMetrics.get(1).getId()).isEqualTo(2L);
        assertThat(retrievedMetrics.get(1).getType()).isEqualTo(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_CONSTRUCTOR_INVOCATIONS);
        assertThat(retrievedMetrics.get(1).getValue()).isEqualTo(2.4567F);

        assertThat(retrievedMetrics.get(2).getId()).isEqualTo(3L);
        assertThat(retrievedMetrics.get(2).getType()).isEqualTo(ClassMetricType.BIDIRECTIONAL_NUMBER_OF_CLASS_METHOD_INVOCATIONS);
